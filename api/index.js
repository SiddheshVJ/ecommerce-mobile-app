...
app.listen(port, IpAdressofyourpc, () => {
  console.log(`Server is running on http://${IpAdressofyourpc}`);
});

mongoose
  .connect("mongodb://127.0.0.1:27017/ecommerce-mobile-app", {
...
const sendVerificationEmail = async (email, verificationToken) => {
  ...
  const transporter = nodemailer.createTransport({
    ...
    service: "gmail",
    auth: {
      user: "Siddheshvjadhav20@gmail.com",
      pass: "$idDjadhav200897",
    },
  });
